package com.helospark.sparktemplatingplugin.handlers.executor;
...
public class ExecutorDialog extends FilteredItemsSelectionDialog {
    ...
    public ExecutorDialog(Shell shell, ScriptRepository scriptRepository) {
        super(shell);
        this.scriptRepository = scriptRepository;
        super.setListLabelProvider(new ILabelProvider() {
