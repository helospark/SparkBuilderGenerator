...
public class ExecutionHandler extends AbstractHandler {
    private static final PluginLogger LOGGER = new PluginLogger(ExecutionHandler.class);
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        try {
            ...
            TemplateBrowseDialog templateBrowseDialog = new TemplateBrowseDialog(shell, scriptRepository,
                    "Select an template to run");
            ...
            LOGGER.error("Unable to handle template execution", e);
        }
        return null;
    }
