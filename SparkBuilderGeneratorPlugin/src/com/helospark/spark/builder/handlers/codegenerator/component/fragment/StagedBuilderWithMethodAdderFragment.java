...
public class StagedBuilderWithMethodAdderFragment {
    ...
    public void addWithMethodToBuilder(AST ast, TypeDeclaration stagedBuilderType, NamedVariableDeclarationField namedVariableDeclarationField) {
        ...
        MethodDeclaration newWithMethod = stagedBuilderMethodDefiniationCreatorFragment.createNewWithMethod(ast, namedVariableDeclarationField);
