...
public class RegularBuilderWithMethodAdderFragment {
    ...
    public RegularBuilderWithMethodAdderFragment(PreferencesManager preferencesManager, JavadocGenerator javadocGenerator, NonNullAnnotationAttacher nonNullAnnotationAttacher,
    ...
    public void addWithMethodToBuilder(AST ast, TypeDeclaration newType, NamedVariableDeclarationField namedVariableDeclarationField) {
