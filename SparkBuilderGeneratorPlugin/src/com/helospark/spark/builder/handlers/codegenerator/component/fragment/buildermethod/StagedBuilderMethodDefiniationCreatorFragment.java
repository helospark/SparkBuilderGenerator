...
public class StagedBuilderMethodDefiniationCreatorFragment {
	...
	public MethodDeclaration createNewWithMethod(AST ast, NamedVariableDeclarationField namedVariableDeclarationField,
		...
		builderMethod.setReturnType2(
				ast.newSimpleType(ast.newName(nextStage.getInterfaceName())));
		builderMethod.parameters()
				.add(createMethodParameter(ast, namedVariableDeclarationField.getFieldDeclaration(), fieldName));
