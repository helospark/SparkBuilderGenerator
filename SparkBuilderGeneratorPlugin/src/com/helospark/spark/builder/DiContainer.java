...
public class DiContainer {
	...
	public static void initializeDiContainer() {
		...
		addDependency(new StagedBuilderInterfaceAdderFragment(getDependency(StagedBuilderMethodDefiniationCreatorFragment.class),
		...
		addDependency(new StagedBuilderCompilationUnitGenerator(getDependency(ApplicableBuilderFieldExtractor.class),
				...
				getDependency(StagedBuilderInterfaceAdderFragment.class)));
